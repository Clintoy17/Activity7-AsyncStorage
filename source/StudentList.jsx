...
const StudentList = () => {
  ...
  return (
    <View style={{ height: 'auto', backgroundColor: 'skyblue' }}>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              ...
              <View style={{ marginBottom: 15 }}>
                <Text style={styles.modData}>{`Firstname: ${selectedStudent?.firstName}`}</Text>
                <Text style={styles.modData}>{`Lastname: ${selectedStudent?.lastName}`}</Text>
